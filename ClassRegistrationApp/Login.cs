...
namespace ClassRegistrationApp
{
    public partial class LoginForm : Form
    {
        ...
        public LoginForm()
        {
            ...
            CourseList.Add(new Course("CO002", "Java Programming", 4));
            CourseList.Add(new Course("CO003", "Data Structure", 4));
            CourseList.Add(new Course("CO004", "Database Management", 4));
            CourseList.Add(new Course("CO005", "Web Design", 4));
            CourseList.Add(new Course("CO006", "Pattern Regconition", 4));
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (SpecificOne == null)
            {
                MessageBox.Show("Username and Password are not match.\nPlease reinput or register a new one",
